...
Route::prefix('customer')->middleware(['auth:web', 'role:pelanggan,customer'])->group(function () {
    ...
    Route::get('jadwal/{id}/detail', [CustomerJadwalController::class, 'show'])->name('customer.jadwal.detail.alias');
    ...
    Route::get('pengajuan/{id}/detail', [CustomerPengajuanController::class, 'show'])->name('customer.pengajuan.detail.alias');
    ...
    Route::get('pembayaran/{id}/detail', [CustomerPembayaranController::class, 'show'])->name('customer.pembayaran.show.alias');
    ...
    Route::get('hasiluji/{hasil_uji}/detail', [CustomerHasilUjiController::class, 'show'])->name('customer.hasil_uji.detail.alias');
...
Route::prefix('pegawai')->group(function () {
    ...
    Route::get('pengajuan/{id}/detail', [PegawaiPengajuanController::class, 'show'])->middleware('check.permission:detail pengajuan')->name('pegawai.pengajuan.detail.alias');
    ...
    Route::middleware('check.permission:kelola pembayaran')->group(function () {
        ...
        Route::get('pembayaran/{id}/detail', [PegawaiPembayaranController::class, 'show'])->name('pegawai.pembayaran.detail.alias');
    ...
    Route::get('pengujian/{pengujian}/detail', [PengujianController::class, 'show'])->middleware('check.permission:detail pengujian')->name('pegawai.pengujian.detail.alias');
    ...
    Route::get('pengambilan/{jadwal}/detail', [PegawaiJadwalController::class, 'show'])->middleware('check.permission:detail pengambilan')->name('pegawai.pengambilan.detail.alias');
    ...
    Route::middleware('check.permission:kelola kategori')->group(function () {
        ...
        Route::get('kategori/{id}/detail', [KategoriController::class, 'show'])->name('pegawai.kategori.detail.alias');
    ...
    Route::middleware('check.permission:kelola subkategori')->group(function () {
        ...
        Route::get('subkategori/{id}/detail', [SubKategoriController::class, 'show'])->name('pegawai.subkategori.detail.alias');
    ...
    Route::get('hasiluji/{id}/detail', [PegawaiHasilUjiController::class, 'show'])->middleware('check.permission:detail hasil uji')->name('pegawai.hasil_uji.detail.alias');
    ...
    Route::middleware('check.permission:kelola aduan')->group(function () {
        ...
        Route::get('aduan/{aduan}/detail', [VerifikasiAduanController::class, 'show'])->name('pegawai.aduan.detail.alias');
