...
<template>
    ...
    <aside :class="['fixed lg:static z-10 bg-green-800 text-white min-h-screen transition-all duration-300 ease-in-out',
        ...
        <nav class="space-y-1 font-bold text-xl">
            ...
            <!-- Menu Permission -->
            <Link v-if="can('kelola permission')" href="/superadmin/permission"
            ...
            <!-- Menu Role -->
            <Link v-if="can('kelola role')" href="/superadmin/role"
                class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            ...
            <!-- Menu User -->
            <Link v-if="can('kelola user')" href="/superadmin/users"
                class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            <img src="/storage/assetsadmin/role.png" alt="Role" class="w-6 h-6" />
            <span>User</span>
            </Link>
            ...
            <div class="space-y-1"
                ...
                <Transition name="slide">
                    <div v-if="isKategoriOpen" class="pl-8 space-y-1">
                        ...
                        <Link v-if="can('kelola jenis cairan')" href="/pegawai/jenis-cairan"
                            class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            ...
            <Link v-if="can('kelola instansi')" href="/pegawai/instansi"
                class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link v-if="can('lihat hasil uji')" href="/pegawai/hasiluji"
                class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="/pegawai/profile/show" class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="sso/logout" class="flex items-center gap-3 py-3 px-3 hover:bg-green-700 rounded">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
