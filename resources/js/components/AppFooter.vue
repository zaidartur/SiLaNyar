...
<template>
    <footer class="bg-green-700 px-6 pb-8 pt-16 text-white md:px-20">
                ...
                <div class="mt-6 space-y-4 text-sm text-zinc-300">
                    ...
                    <div class="space-y-3">
                        ...
                        <p class="flex items-center gap-2">
                            ...
                            <a href="#" class="underline hover:text-zinc-100" title="Kirim email ke DLH Karanganyar">
                                dlh@karanganyarkab.go.id </a>
                        </p>
                    </div>
                </div>
            </section>
        ...
        <div class="mt-10 text-center text-xs text-zinc-300">&copy; 2025 Dinas Lingkungan Hidup Karanganyar. All rights
            reserved.</div>
    </footer>
</template>
