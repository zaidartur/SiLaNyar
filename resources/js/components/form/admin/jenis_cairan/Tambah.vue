            ...
            <div class="flex items-center justify-center p-12 lg:col-span-2 bg-white">
                <form @submit.prevent="submit" class="mx-auto grid w-full max-w-sm gap-6">
                    <div class="grid gap-2 text-center">
                        <h1 class="text-3xl font-bold">Tambah Jenis Cairan</h1>
                    </div>
                    <div class="grid gap-4">
                        <div class="grid gap-2">
                            <Label for="nama">Nama Jenis Cairan</Label>
                            <Input id="nama" v-model="form.nama" type="text" placeholder="Contoh: Air Limbah"
                                required />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="batas_minimum" v-model="form.batas_minimum" type="number" min="0"
