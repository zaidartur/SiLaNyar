            ...
            <div class="max-h-[90vh] overflow-y-auto p-6">
                ...
                <div class=" mb-4">
                    ...
                    <button @click="closeModal"
                        class="absolute top-3 right-4 text-gray-400 hover:text-gray-600">✕</button>
                </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input v-model="form.nama" type="text" placeholder="Masukan nama instansi"
                            ...
                            <div>
                                ...
                                <textarea v-model="form.alamat" placeholder="Masukan alamat lengkap instansi"
                                    class="mt-1 block w-full border rounded-md p-2" rows="3"></textarea>
                                <span v-if="form.errors.alamat" class="text-sm text-red-600">
                                    {{ form.errors.alamat }}
                                </span>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Wilayah</label>
                                <input v-model="form.wilayah" type="text" placeholder="Kabupaten Karanganyar"
                                    class="mt-1 block w-full border rounded-md p-2" />
                                <span v-if="form.errors.wilayah" class="text-sm text-red-600">
                                    {{ form.errors.wilayah }}
                                </span>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Desa/Kelurahan</label>
                                <input v-model="form.desa_kelurahan" type="text" placeholder="Pilih desa dan kelurahan"
                                    class="mt-1 block w-full border rounded-md p-2" />
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input v-model="form.email" type="email" placeholder="Email instansi"
                                    class="mt-1 block w-full border rounded-md p-2" />
                            ...
                            <div>
                                ...
                                <input v-model="form.no_telepon" type="tel" placeholder="Contoh: 081123456789"
                                    class="mt-1 block w-full border rounded-md p-2" />
                                <span v-if="form.errors.no_telepon" class="text-sm text-red-600">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input v-model="form.posisi_jabatan" type="text"
                                    placeholder="Contoh: Administrator, Staff Laboratorium"
                                    class="mt-1 block w-full border rounded-md p-2" />
                                <span v-if="form.errors.posisi_jabatan" class="text-sm text-red-600">
                                    {{ form.errors.posisi_jabatan }}
                                </span>
                            </div>
                            <div>
                                ...
                                <span v-if="form.errors.departemen_divisi" class="text-sm text-red-600">
                                    {{ form.errors.departemen_divisi }}
                                </span>
                                <p class="text-xs italic text-gray-500 mt-1">Opsional - Isi jika berlaku di instansi
                                    Anda</p>
                            </div>
                        </div>
                    </div>
