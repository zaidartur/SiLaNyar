...
<template>
    ...
    <Head title="SiLanYar">
        <link rel="icon" type="image/png" href="/storage/assetsadmin/logodlh.png" />
    ...
    <div
        ...
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                <Link v-if="$page.props.auth.user" :href="route('customer.dashboard')"
                ...
                <template v-else>
                    ...
                    <Link :href="route('customer.registrasi')"
                        class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
                    Register
                    </Link>
                </template>
            ...
            <main
                ...
                <div
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Laravel has an incredibly rich ecosystem. Anjay mabar (ini buat test CI/CD) <br />We suggest
                        starting
                        with the following.
                    </p>
