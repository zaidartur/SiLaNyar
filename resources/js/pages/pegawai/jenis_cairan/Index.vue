    ...
    <AdminLayout>
        <div class="p-6">
            <div class="mb-6 flex items-center justify-between">
                ...
                <button @click="openTambahModal" class="rounded bg-green-600 px-4 py-2 text-white hover:bg-green-700">Tambah</button>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-300 rounded-lg bg-white">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr
                            v-for="(item, index) in props.jenis_cairan"
                            :key="item.id"
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-left">
                                <div class="flex gap-2">
                                    ...
                                    <button @click="openDeleteModal(item)" class="text-red-500" type="button">🗑️</button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <Dialog :open="showDeleteModal" @update:open="closeDeleteModal">
                ...
                >
                    ...
                    <div class="text-center">
                        <p class="font-bold text-gray-900">HAPUS JENIS CAIRAN {{ deletingJenisCairan?.kode_jenis_cairan }}</p>
