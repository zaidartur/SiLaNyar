...
const totalPages = computed(() =>
    Math.ceil(filteredKategori.value.length / pageSize)
);
            ...
            <div class="overflow-x-auto rounded-lg shadow-md">
                <table class="min-w-full divide-y divide-gray-300 bg-white">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr v-for="(item, index) in paginatedKategori" :key="item.id"
                        ...
                        <tr v-if="paginatedKategori.length === 0">
                            <td colspan="6" class="text-center text-gray-400 py-6">Tidak ada data kategori.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
