        ...
        <div class="p-6">
            ...
            <div class="mb-6 flex items-end gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input id="tanggal" type="date" v-model="tanggal" class="rounded border-gray-300 bg-customDarkGreen px-2 py-1 text-white" />
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full overflow-hidden rounded-xl bg-white shadow">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in props.jadwal" :key="item.id" :class="index % 2 === 0 ? 'bg-white' : 'bg-gray-200'">
