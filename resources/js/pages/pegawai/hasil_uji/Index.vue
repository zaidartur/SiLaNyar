        ...
        <div class="p-6">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full overflow-hidden rounded-xl bg-white shadow">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in hasil_uji" :key="item.id" :class="index % 2 === 0 ? 'bg-white' : 'bg-gray-200'">
                            ...
                            <td class="border-b px-4 py-3">
                                <div class="flex gap-2">
                                    ...
                                    <Link
                                        :href="route('pegawai.hasil_uji.edit', item.id)"
                ...
                >
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">
                            ...
                            <span class="font-bold">{{ deletingHasilUji?.pengujian?.form_pengajuan?.instansi?.nama ?? '-' }}</span>
                            ?
                        </p>
                    </div>
