                            ...
                            <div class="relative">
                                ...
                                <div class="space-y-6">
                                    <div v-for="(item, index) in props.statusList" :key="index" class="flex items-center">
                                        ...
                                        >
                                            <div :class="['h-4 w-4 rounded-full', item.status ? 'bg-customDarkGreen' : 'bg-gray-400']"></div>
                                        </div>
                                        <div class="ml-4">
                                            <p :class="['font-medium', item.status ? 'text-customDarkbg-customDarkGreen' : 'text-gray-600']">
                                                {{ item.label }}
                                            </p>
