...
const formSchema = [
    ...
    z
        ...
        .refine(
            (data) => {
                const anyFisikaSelected = Object.values(data.parameter).some(Boolean);
                return anyFisikaSelected;
            },
            {
                    ...
                    <Stepper v-slot="{ isNextDisabled, isPrevDisabled, nextStep, prevStep }" v-model="stepIndex"
                        ...
                        <div>
                            ...
                            <div class="mt-4 flex flex-col gap-4">
                                                        ...
                                                        <div v-for="(jenis, index) in ['Universal', 'Lemak', 'Vecal coli']"
                                                            :key="index" :class="[
                                                                ...
                                                                componentField.modelValue === jenis.toLowerCase()
                                                                    ...
                                                                    : 'bg-white hover:border-customDarkGreen'
                                            ...
                                            <FormField v-slot="{ componentField }" name="instansi">
                                                <FormItem>
                                                    ...
                                                    <Select v-bind="componentField">
                                                        ...
                                                        <SelectContent>
                                                            <SelectGroup>
                                                                <SelectItem value="perguruan-tinggi"> Perguruan Tinggi
                                                                </SelectItem>
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <Button type="button" variant="outline" :class="[
                                                            ...
                                                            componentField.modelValue === 'diantar'
                                                                ? 'border-customDarkGreen bg-customLightGreen'
                                                                : 'bg-white hover:border-customDarkGreen hover:bg-customLightGreen'
                                ...
                                <template v-if="stepIndex === 2">
                                    <div class="space-y-6">
                                        ...
                                        <!-- Parameter Fisika -->
                                        <div class="space-y-4">
                                            <h3 class="font-medium text-green-700">Parameter</h3>
                                            <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="boerder-t mt-8 flex items-center justify-between pt-6">
                                <Button :disabled="isPrevDisabled" variant="outline" size="sm" @click="prevStep"> Back
                                </Button>
                                <div class="flex items-center gap-3">
                                    <Button v-if="stepIndex !== steps.length" type="submit" size="sm"
                                        :disabled="!meta.valid"> Next </Button>
                                    <Button v-if="stepIndex === steps.length" type="submit" size="sm"
                                        :disabled="!meta.valid"> Submit </Button>
                                </div>
                            </div>
                        </div>
                    </Stepper>
