...
import { Check, Circle, Dot, CheckCircle } from 'lucide-vue-next'
...
const formSchema = [
    ...
    z.object({
        ...
        volume: z.number({ invalid_type_error: "Volume harus diisi" })
    .min(2.5, "Volume minimal 2.5 L"),
    ...
    z.object({
        ...
        buktiPembayaran: z.instanceof(File).optional().refine((val) => {
            if (!val) return true;
                ...
                <Form v-slot="{ meta, values }" @submit="handleSubmit"
                    ...
                    <Stepper v-slot="{ isNextDisabled, isPrevDisabled, nextStep, prevStep }" v-model="stepIndex"
                        ...
                        <div>
                                                            ...
                                                            <div class="flex flex-col items-center gap-2">
                                                                <svg v-if="jenis === 'Universal'" width="59" height="56"
                                                                    ...
                                                                    <defs>
                                                                        ...
                                                                        <image id="image0_1433_1546" width="100"
                                                                ...
                                                                <svg v-if="jenis === 'Lemak'" width="59" height="56"
                                                                    ...
                                                                    <defs>
                                                                        ...
                                                                        <image id="image0_1433_1547" width="100"
                                                                            height="100" preserveAspectRatio="none"
                                                                ...
                                                                <svg v-if="jenis === 'Vecal coli'" width="59"
                                                                    height="56" viewBox="0 0 59 56" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                    <ellipse cx="29.5" cy="28" rx="29.5" ry="28"
                                                                        fill="#F5F5F5" />
                                                                    ...
                                                                    <defs>
                                                                        ...
                                                                        <image id="image0_1433_1548" width="100"
                                                                            height="100" preserveAspectRatio="none"
                                        ...
                                        <div class="bg-gray-100 rounded-lg shadow-sm p-4 space-y-4">
                                            ...
                                            <FormField v-slot="{ componentField }" name="volume">
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <div class="relative">
                                                            <Input type="number" step="0.01" min="2.5"
                                                                v-bind="componentField" placeholder="Min : 2.5 L"
                                                                class="pl-10" />
                                                            ...
                                                            <div
                                                                ...
                                                                <svg width="21" height="21" viewBox="0 0 21 21"
                                                                    ...
                                                                    <defs>
                                                                        ...
                                                                        <image id="image0_1393_1242" width="100"
                                                                            height="100" preserveAspectRatio="none"
                                            ...
                                            <FormField v-if="values.metodePengambilan === 'diantar'"
                                                v-slot="{ componentField }" name="tanggalPengantaran">
                                                <FormItem>
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-4">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <h3 class="text-lg font-medium text-customDarkGreen">Pilih Kategori
                                                    Pengujian
                                                </h3>
                                            </div>
                                            <Select>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <FormField v-slot="{ componentField }"
                                                    name="parameterKimia.minyakLemak">
                                                    <FormItem class="flex items-center space-x-3 space-y-0">
                                                        <FormControl>
                                                            <Checkbox v-bind="componentField" />
                                                        </FormControl>
                                    ...
                                    <div class="space-y-4">
                                        <FormField v-slot="{ componentField }" name="konfirmasiData">
                                            <FormItem>
                                                ...
                                                <span class="text-xs text-gray-500">Saya telah memeriksa dan data sudah
                                                    benar.</span>
                                                <FormMessage />
                                            </FormItem>
                                        </FormField>
                                        <FormField v-slot="{ componentField }" name="persetujuanLayanan">
                                            <FormItem>
                                                ...
                                                <span class="text-xs text-gray-500">Saya menyetujui syarat dan ketentuan
                                                    layanan.</span>
                                                <FormMessage />
                                            </FormItem>
                                        </FormField>
                            ...
                            <div class="flex items-center justify-between mt-8 boerder-t pt-6">
                                <Button :disabled="isPrevDisabled" variant="outline" size="sm" @click="prevStep">
                                    Back
                                </Button>
                                <div class="flex items-center gap-3">
                                    <Button v-if="stepIndex !== steps.length" type="submit" size="sm"
                                        :disabled="!meta.valid">
                                        Next
                                    </Button>
                                    <Button v-if="stepIndex === steps.length" type="submit" size="sm"
