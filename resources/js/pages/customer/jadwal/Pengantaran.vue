...
<template>
    <Head title="Jadwal Pengantaran Sampel Mandiri" />

    <CustomerLayout title="Jadwal Pengantaran">
        <div class="space-y-6">
            ...
            <!-- Petunjuk Pengantaran -->
            <div class="p-4 rounded-2xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-900 dark:text-emerald-200 text-xs flex items-start gap-3">
                <v-icon size="20" color="primary" class="mt-0.5 shrink-0">mdi-information</v-icon>
                <div>
                    <strong class="font-bold">Ketentuan Pengantaran Sampel:</strong> Silakan bawa contoh uji ke Gedung Laboratorium Lingkungan Hidup Kabupaten Karanganyar (Jl. Lawu No. 204) pada jam operasional: Senin - Kamis (08.00 - 15.00 WIB) dan Jumat (08.00 - 14.30 WIB).
                </div>
            </div>
                ...
                <div>
                    <div class="flex items-center gap-2.5">
                        <h1 class="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">
                            Jadwal Pengantaran Sampel Mandiri
                        </h1>
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Daftar jadwal penyerahan sampel yang Anda antarkan langsung ke laboratorium
                    </p>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-emerald-900 text-white dark:bg-emerald-950 dark:text-emerald-200 border-b border-emerald-800 dark:border-emerald-900 text-xs font-bold uppercase tracking-wider">
                                <th class="py-3.5 px-5">Kode Pengantaran</th>
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800/80 text-xs">
                            ...
                            >
                                <td class="py-3.5 px-5 whitespace-nowrap">
                                    <span class="font-mono font-bold text-xs px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-800 dark:bg-emerald-950/80 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                                        {{ item.kode_pengambilan || `ANT-${item.id}` }}
                                    </span>
                                </td>
                            ...
                            <tr v-if="filteredJadwal.length === 0">
                                <td colspan="6" class="text-center py-12 text-slate-400 dark:text-slate-500">
                                    <v-icon size="36" class="mb-2 text-slate-300 dark:text-slate-600">mdi-clock-outline</v-icon>
                                    <p class="font-medium text-xs">Tidak ada data jadwal pengantaran.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
