      ...
      <div class="mb-4 p-2 bg-white rounded-lg shadow-sm border border-gray-300">
        ...
        <div class="p-6">
          <div class="grid gap-6">
            ...
            <div class="space-y-4 bg-gray-100 rounded-lg shadow-sm border border-gray-300 p-4">
            ...
            <div>
              ...
              <div class="grid gap-3">
                <div v-if="props.instansi.length > 0">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div v-for="item in props.instansi" :key="item.id"
                      class="rounded-lg border border-l-8 border-l-customDarkGreen bg-gray-100 shadow-md flex flex-col justify-between">
                      <div class="flex items-center justify-between p-3">
                        <div>
                          <p class="font-bold">{{ item.nama }}</p>
                          <p class="font-bold text-sm text-gray-500">{{ item.tipe }}</p>
                        </div>
                        <div class="flex gap-2">
                          <button class="p-1 text-gray-400 hover:text-gray-600" @click="editInstansi(item.id)">
                            <svg width="20" height="23" viewBox="0 0 20 23" fill="none"
                              ...
                              <defs>
                                <pattern id="pattern0_1273_906" patternContentUnits="objectBoundingBox" width="1"
                                  height="1">
                                  <use xlink:href="#image0_1273_906"
                                    transform="matrix(0.01 0 0 0.00869565 0 0.0652174)" />
                                </pattern>
                                <image id="image0_1273_906" width="100" height="100" preserveAspectRatio="none"
                          ...
                          <button class="p-1 text-red-400 hover:text-red-600" @click="openDeleteInstansiModal(item)">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                              ...
                              <defs>
                                <pattern id="pattern0_1272_903" patternContentUnits="objectBoundingBox" width="1"
                                  height="1">
                                  <use xlink:href="#image0_1272_903" transform="scale(0.01)" />
                                </pattern>
                                <image id="image0_1272_903" width="100" height="100" preserveAspectRatio="none"
                ...
                <EditInstansi v-model="showEditInstansiModal" :instansi="instansiEditData"
            ...
            <Dialog :open="showDeleteInstansiModal" @update:open="closeDeleteInstansiModal">
              <DialogContent
                ...
                <div class="mt-6 flex justify-center gap-4">
                  <button @click="closeDeleteInstansiModal"
                    class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">
                    Batal
                  </button>
                  <button @click="handleDeleteInstansi"
