        ...
        <div class="rounded border-l-4 border-green-600 bg-white shadow p-4">
            ...
            <div class="flex gap-4 mb-4">
                ...
                <template v-if="pengajuan.metode_pengambilan === 'diantar'">
                    <button type="button" :class="[
                        'flex-1 flex items-center border rounded p-3 transition',
                        metode === 'tunai'
                    ...
                    <button type="button" :class="[
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500">Pembayaran melalui transfer bank ke rekening Bank Jateng
                            </div>
                        </div>
                    </button>
                </template>
            ...
            <div v-if="metode === 'transfer'">
                <div class="bg-green-50 border border-green-200 rounded p-3 mb-2">
                    ...
                    <ol class="space-y-2 text-sm list-decimal list-inside pl-2">
                        <li>
                            Salin nomor rekening tujuan: <b>3-001-12345-6</b><br>
                            atas nama <b>DINAS PERTANIAN KAB. KARANGANYAR</b>.
                        </li>
                        <li>
                            Lakukan transfer dari rekening Bank Jateng Anda atau melalui ATM/Mobile Banking/Internet
                            Banking Bank Jateng.
                        </li>
                        <li>
                ...
                <div class="flex flex-col items-center border border-dashed border-green-400 rounded p-6 bg-green-50 mb-2"
                    ...
                    <template v-else>
                        <span class="text-green-700 font-semibold">File: {{ buktiPembayaran.name }}</span>
                        <img v-if="previewUrl" :src="previewUrl" alt="Preview Bukti Transfer"
                            class="mt-2 max-h-40 rounded shadow" />
                        <span v-if="buktiPembayaran && !previewUrl" class="text-xs text-gray-500 mt-2">
