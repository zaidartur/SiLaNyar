...
<template>
    ...
    <div class="mx-auto max-w-2xl space-y-6 py-6">
        ...
        <!-- Ringkasan Pengajuan -->
        <div class="rounded border-l-4 border-green-600 bg-white p-4 shadow">
            <div class="mb-2 flex items-center">
                <span class="mr-2 text-green-600">
                    ...
                    >
                        ...
                        <defs>
                            <pattern id="pattern0_1709_2397" patternContentUnits="objectBoundingBox" width="1" height="1">
                                <use xlink:href="#image0_1709_2397" transform="matrix(0.01 0 0 0.00882353 0 0.0588235)" />
                            </pattern>
                            <image
                                id="image0_1709_2397"
                                width="100"
        ...
        <div class="rounded border-l-4 border-green-600 bg-white p-4 shadow">
                ...
                <template v-if="pengajuan.metode_pengambilan === 'diantar'">
                    ...
                    >
                        ...
                        >
                            ...
                            <defs>
                                <pattern id="pattern0_1323_4749" patternContentUnits="objectBoundingBox" width="1" height="1">
                    ...
                    <button
                        ...
                        "
                    >
                        <img src="@/components/assets/customer/BankJateng.png" alt="Bank Jateng" class="mr-3 h-10 w-28 object-contain" />
                        <div>
            ...
            <div v-if="metode === 'transfer'">
                <div class="mb-2 rounded border border-green-200 bg-green-50 p-3">
                    ...
                    <ol class="list-inside list-decimal space-y-2 pl-2 text-sm">
                        ...
                        <li>Lakukan transfer dari rekening Bank Jateng Anda atau melalui ATM/Mobile Banking/Internet Banking Bank Jateng.</li>
                        <li>
                            Transfer sebesar <b>Rp. {{ pembayaran ? pembayaran.total_biaya.toLocaleString('id-ID') : 0 }}</b
                            >.
                        </li>
                        <li>
                        ...
                        <li>Upload bukti transfer melalui halaman konfirmasi pembayaran yang akan muncul setelah menekan tombol <b>"Bayar"</b>.</li>
                    ...
                    <div class="mt-3 rounded border border-yellow-300 bg-yellow-100 p-2 text-xs text-yellow-700">
                        <b>Catatan Penting:</b> Pembayaran harus dilakukan dalam waktu 24 jam sejak pengajuan. Jika tidak, pengajuan akan otomatis
                        dibatalkan oleh sistem.
                    </div>
                </div>
                <!-- Area Upload Bukti Transfer -->
                <div
                    class="mb-2 flex flex-col items-center rounded border border-dashed border-green-400 bg-green-50 p-6"
                    @drop="handleDrop"
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <img v-if="previewUrl" :src="previewUrl" alt="Preview Bukti Transfer" class="mt-2 max-h-40 rounded shadow" />
                        <span v-if="buktiPembayaran && !previewUrl" class="mt-2 text-xs text-gray-500"> File berhasil dipilih. </span>
                    </template>
                    <input type="file" ref="fileInput" class="hidden" accept="image/jpeg,image/png,application" @change="handleFileChange" />
                </div>
            </div>
            <!-- Checkbox -->
            <div class="mb-2 flex items-start">
                ...
                <label for="syarat" class="text-xs text-gray-700">
                    Saya menyatakan bahwa semua informasi yang diberikan adalah benar dan akurat. Saya juga menyetujui syarat dan ketentuan yang
            ...
            <div class="flex justify-end space-x-2">
                <button
                    class="rounded border border-gray-300 bg-white px-4 py-2 text-gray-700 hover:bg-gray-100"
                    type="button"
                    @click="$inertia.visit(route('customer.dashboard'))"
                >
                    Batal
                </button>
                <button
